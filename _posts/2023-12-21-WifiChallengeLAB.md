...
There are two versions available on WiFiChallengeslabs. There are some minor differents in the environments, but for the main attacks you could either one of them to practice.
